...
public class DCTERMS {
     ...
     */
    public static final IRI JIRIsdiction;
    ...
    /**
     * A location, period of time, or jIRIsdiction.
     */
    public static final IRI LocationPeriodOrJIRIsdiction;
    ...
    /**
     * Information about who can access the resource or an indication of its secIRIty status.
     */
    ...
    /**
     * The spatial or temporal topic of the resource, the spatial applicability of the resource, or the jIRIsdiction under which the resource is relevant.
     */
    ...
    static{
        ...
        JIRIsdiction = factory.createIRI(DCTERMS.NAMESPACE, "JIRIsdiction");
        ...
        LocationPeriodOrJIRIsdiction = factory.createIRI(DCTERMS.NAMESPACE, "LocationPeriodOrJIRIsdiction");
